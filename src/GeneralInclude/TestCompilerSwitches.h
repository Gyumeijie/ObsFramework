...
/**
 * @file TestCompilerSwitches.h 
 * This file defines the compiler switches used by the test
 * classes of the OBS Framework. Compiler switches used by the operational
